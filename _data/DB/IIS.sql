...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pe000404db`.`vObjednavkaAdresaClen` (`id` INT, `cislo` INT, `termin` INT, `suma` INT, `vybavene` INT, `vodic` INT, `podal` INT, `adresaId` INT, `oblast` INT, `clen` INT, `adresa` INT);
...
USE `pe000404db`;
CREATE  OR REPLACE VIEW `vObjednavkaPecivo` AS SELECT o.*, z.mnozstvo, p.nazov, p.popis, p.cena FROM vObjednavka AS o LEFT JOIN vZoznam AS z ON z.objednavka = o.id LEFT JOIN vPecivo AS p ON p.id = z.pecivo ORDER BY p.nazov ASC;
...
USE `pe000404db`;
CREATE  OR REPLACE VIEW `vObjednavkaAdresa` AS SELECT o.id, o.cislo, o.termin, o.suma, o.vybavene, o.vodic, o.podal, a.id AS adresaId, a.oblast, a.clen, a.adresa FROM vObjednavka AS o LEFT JOIN vAdresa AS a ON o.adresa = a.id ORDER BY o.cislo DESC;
...
USE `pe000404db`;
CREATE  OR REPLACE VIEW `vObjednavkaAdresaClen` AS SELECT o.id, o.cislo, o.termin, o.suma, o.vybavene, o.vodic, o.podal, a.id AS adresaId, a.oblast, a.clen, a.adresa FROM vObjednavka AS o LEFT JOIN vAdresa AS a ON o.adresa = a.id LEFT JOIN vClen AS c ON a.clen = c.id ORDER BY o.cislo DESC;
